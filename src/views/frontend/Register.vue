    ...
    <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
      <div class="flex flex-col overflow-y-auto md:flex-row">
        <div class="h-32 md:h-auto md:w-1/2">
          <img aria-hidden="true" class="object-cover w-full h-full" src="@/assets/img/create-account-office.webp"
            alt="Office" />
        </div>
        ...
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
          ...
          <div class="w-full">
            ...
            <form @submit.prevent="onSubmit">
              ...
              <input v-model="username" :class="{'border-red-600': v$.username.$errors.length}"
            ...
            <p class="mt-2">
              <router-link to="/login" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline">
                ฉันเป็นสมาชิกอยู่แล้ว ? เข้าสู่ระบบ</router-link>
            </p>
          </div>
        </div>
      </div>
